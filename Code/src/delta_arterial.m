...
function [arterial_SpO2_new, arterial_glucose_new, arterial_insulin_new] = delta_arterial(arterial_SpO2, arterial_glucose, arterial_insulin, gut_glucose_output,gut_glucose_absorption, O2_used, time)
    ...
    arterial_glucose_new = arterial_glucose + gut_glucose_output - gut_glucose_absorption;
