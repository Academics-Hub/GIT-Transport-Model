function [SpO2_new, glucose_new] = delta_gut(SpO2,gut_glucose,Insulin,GutFlowRate,time_step)
    ...
    GUT_PARAMS.setget_glucose_absorption(0); % replace with Dinal's function to get glucose absorbed
    ...
    GUT_PARAMS.setget_O2_consumption(0); % replace with Julia's function to get O2 used -> O2 to be subtracted from arterial
