...
xlim([0, duration/3600])
xticks(0:1:duration/3600)
print -dpng vary_change_in_gut_glucose_absorption
% 
%subplot(5,1,3)
...
xlim([0, duration/3600])
xticks(0:1:duration/3600)
print -dpng vary_glycaemic_load
...
xlim([0, duration/3600])
xticks(0:1:duration/3600)
print -dpng vary_gut_glucose_output
...
xlim([0, duration/3600])
xticks(0:1:duration/3600)
print -dpng vary_change_in_venous_glucose
...
xlim([0, duration/3600])
xticks(0:1:duration/3600)
print -dpng vary_change_in_insulin
...
xlim([0, duration/3600])
xticks(0:1:duration/3600)
print -dpng vary_change_of_gut_O2
...
xlim([0, duration/3600])
xticks(0:1:duration/3600)
print -dpng vary_change_of_gut_CO2
